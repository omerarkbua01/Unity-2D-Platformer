...
- **Score Manager:** Singleton pattern for score tracking
- **Prefab Workflow:** Reusable Player and Obstacle prefabs
- 
## 🛠️ Technical Details
- **Engine:** Unity 6.3 LTS
- **Language:** C#
- **Platform:** macOS (PC build)
- **Camera:** Cinemachine 3.x
- **Physics:** Rigidbody2D with Interpolation

## 📹 Demo
- [v0.1 Release](https://github.com/omerarkbua01/Unity-2D-Platformer/releases/tag/v0.1) - Basic movement + jump
- [v0.2 Release](https://github.com/omerarkbua01/Unity-2D-Platformer/releases/tag/v0.2) - Coin system + pause menu + UI
- 
## 🚀 Development Progress
Following a 7-month learning plan (Month 1 - Week 2-3 completed!)

## 🚀 Development Progress
Following a 7-month learning plan (Month 1 - Week 3 completed!)
...
**Next (Week 4 - Month 1 finale):**
- ⏳ Polish + comprehensive build
- ⏳ Transition to New Input System (Month 2)Prefab workflow
